...
public class DiceCoefficientValueMatchingFunction extends
		TokenBasedSimilarityValueMatchingFunction {

	private static final DiceCoefficientValueMatchingFunction INSTANCE = new DiceCoefficientValueMatchingFunction();
	...
	public DiceCoefficientValueMatchingFunction() {
		super();
	}
	...
	protected double getScore(IAttribute attr1, IAttribute attr2, List<String> list1, List<String> list2) {
		...
		return ((double)overlapTokens.size())*2/(set1.size()+set2.size());
	}
	
	static DiceCoefficientValueMatchingFunction getInstance() {
		return INSTANCE;
	}
	
	@Override
	public String toString() {
		return IValueMatchingFunction.DICE;
	}
