...
public class InconsistencyResolutionResultCombiner extends ResultCombiner {
	...
	public InconsistencyResolutionResultCombiner() {
		super();
		init();
	}
...
//	protected void addToTable(ConflictSet conflictSet) {
		// TODO Reimplement for AccessKnow
//	}
...
//	protected void processConflictGroup(List<ConflictSet> conflictInstances) {
		// TODO Reimplement for AccessKnow
//	}
