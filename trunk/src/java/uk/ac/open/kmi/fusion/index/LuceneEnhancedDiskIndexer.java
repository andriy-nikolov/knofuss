...
public class LuceneEnhancedDiskIndexer extends LuceneIndexer implements IPersistentStore {
	...
	private static Logger log = Logger.getLogger(LuceneEnhancedDiskIndexer.class);
	...
	protected LuceneEnhancedDiskIndexer() {
		this.storePolicy = LuceneStorePolicy.DISK;
	}
	
	public LuceneEnhancedDiskIndexer(ILuceneStore storeStrategy,
			ILuceneSearchStrategy searchStrategy) {
		super(storeStrategy, searchStrategy);
	}
	
	public LuceneEnhancedDiskIndexer(Resource rdfIndividual,
